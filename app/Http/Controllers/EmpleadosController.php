...
class EmpleadosController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request)// FUNCION QUE PERMITE AGREGAR UN EMPLEADO
    {
    ...
    public function update(Request $request,$id)
    {
        ...
        if($request->hasFile('Foto')){
            ...
            $empleado = Empleados::findOrFail($id);    // Busca por id      
            Storage::delete('public/'.$empleado->Foto); // Elimina
